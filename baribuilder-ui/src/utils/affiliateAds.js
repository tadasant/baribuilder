...
const bariatricKetoEbookAd = {
	link: "https://baribuilder.ck.page/4f5e648161",
	imgSrc:
		"https://baribuilder-affiliate-imgs.s3.amazonaws.com/keto-diet-aff-img.png",
};

const backOnTrackEbookAd = {
	link: "https://baribuilder.ck.page/ca8a1a9973",
	imgSrc:
		"https://baribuilder-affiliate-imgs.s3.amazonaws.com/ontrack-mock-aff-img.png",
};

const bariatricVitaminsEbookAd = {
	link: "https://baribuilder.ck.page/f6cb07e0ee",
	imgSrc:
		"https://baribuilder-affiliate-imgs.s3.amazonaws.com/vitamins-mock-aff-img.png",
};

const preOpGuideToBariatricsEbookAd = {
	link: "https://baribuilder.ck.page/058f2745e7",
	imgSrc:
		"https://baribuilder-affiliate-imgs.s3.amazonaws.com/preops-mock-aff-img.png",
};

const bariatricKetoSnacks = {
	link: "https://baribuilder.ck.page/5599df18b2",
	imgSrc:
		"https://baribuilder-affiliate-imgs.s3.amazonaws.com/keto-snacks-aff-img.jpg",
};

const bariatricKetoCourse = {
	link: "https://baribuilder.ck.page/0edbb141e9",
	imgSrc:
		"https://baribuilder-affiliate-imgs.s3.amazonaws.com/drg-course-aff-img.jpg",
};
...
const affiliateAds = {
	...
	default: [
		{
			...backOnTrackEbookAd,
			id: "back-on-track-ebook-bot",
			copy:
				"Struggling with weight regain? Get back on track with this step-by-step ebook.",
		},
		{
			...bariatricKetoCourse,
			id: "keto-course-get-started",
			copy:
				"Have you heard of the bariatric keto diet? Try our e-learning course to get started.",
		},
		{
			...bariatricKetoEbookAd,
			id: "keto-book-read-about",
			copy:
				"Have you heard of the bariatric keto diet? Read all about it in the BariBuilder ebook.",
		},
		{
			...bariatricKetoEbookAd,
			id: "keto-book-regain",
			copy:
				"Experiencing weight regain after surgery? Consider the bariatric keto diet.",
		},
		{
			...bariatricKetoEbookAd,
			id: "keto-book-recipes",
			copy: "Keto for bariatric patients: a book full of recipes.",
		},
		{
			...bariatricKetoSnacks,
			id: "keto-snacks-subscription",
			copy:
				"Enjoy snacking? Make it keto-friendly with our snack subscription box.",
		},
		{
			...bariatricVitaminsEbookAd,
			id: "vitamins-ebook-overpaying",
			copy:
				"You might be overpaying for your vitamins; read more about your options in our ebook.",
		},
		{
			...preOpGuideToBariatricsEbookAd,
			id: "preop-guide-bariatrics-bases",
			copy:
				"Just getting started with weight loss surgery? Read our ebook to cover all your bases.",
		},
	],
};
