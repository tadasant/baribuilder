  ...
  return (
    <PaddedGrid container direction='row'>
      <Grid item xs={12}>
        ...
        <p className="p1"><span className="s1">Please read our Privacy Policy for more information about Vita.G&rsquo;s privacy at&nbsp;
