...
const AboutScreen: SFC = () => {
  return (
    <AboutContainerDiv>
      ...
      <p>
        <Body dark>
        Many patients think they are stuck paying over $50 - sometimes almost as much as $200 - per month for bariatric
        vitamins. This is a large out-of-pocket expense, and it’s no surprise that a financial rough patches often leave
        patients forced to choose between vitamins/health and other basic needs.
        </Body>
      </p>
      <p>
        <Body dark>
        The fact is that you can almost always get the bariatric vitamins you need for as low as $15-20 per month. Yes,
        this often means taking more pills of smaller dosages, but if that’s the difference between being able to afford
      ...
      <p>
        ...
        catalog of all kinds of brands to help you piece together low-cost, high-quality options to get you exactly what
        your body needs.
        </Body>
      </p>
      <br/>
      ...
      <p>
        <Body dark>
        As we began producing products and dove deeper into understanding the needs of the bariatric patient community,
      ...
      <p>
        <Body dark>
        Vita.G and BariBuilder continue to be family owned and operated. You can be sure that there are no corporate or
        shareholder interests pushing for neverending profit growth. Behind the name is just a small group of people who
