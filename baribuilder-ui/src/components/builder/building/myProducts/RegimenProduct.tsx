...
// Pure
const RegimenProductPure: SFC<IProps> = (props) => {
  return (
    <Grid item container direction='row' alignItems='flex-start'>
      <CenteredTextGrid item lg={12}>
        <BodyBold dark>Name</BodyBold>
      </CenteredTextGrid>
      <CenteredTextGrid item lg={12}>
        <Caption dark>Brand</Caption>
      </CenteredTextGrid>
      <CenteredTextGrid item lg={12}>
        <Body dark>{props.quantity.amount}</Body>
      </CenteredTextGrid>
      <CenteredTextGrid item lg={12}>
...
export default RegimenProductPure;
